...
const PercentagePill = props => {
	const pillClassName =
		props.percentage >= 0
			? 'flex items-center px-2 py-0.5 ml-3 text-sm text-green-600 bg-green-100 rounded-full'
			: 'flex items-center px-2 py-0.5 ml-3 text-sm text-red-600 bg-red-100 rounded-full';
	return (

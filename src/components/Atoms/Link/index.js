...
Link.SidebarItem = ({ selected, href = '/', children }) => {
	...
	const selectedClass =
		'hover:text-gray-800 hover:bg-gray-200 flex items-center p-2 my-6 transition-colors dark:hover:text-gray-100 dark:hover:bg-gray-600 duration-200 text-gray-800 dark:text-gray-100 rounded-lg bg-gray-300 dark:bg-gray-600';
	return (
